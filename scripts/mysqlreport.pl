...
# mysqlreport v3.5-maria13 Oct 2 2013
...
# Copyright 2012-2013 Jean Weisbuch
#
...
#  A better test should be implemented
...
#   $have_tokudb_engine = $dbh->selectall_arrayref("SELECT 1 FROM information_schema.plugins WHERE plugin_name = 'TokuDB' AND plugin_version >= 4 AND plugin_status = 'ACTIVE';", undef)->[0][0];
#   if(defined($have_tokudb_engine) && $have_tokudb_engine eq "1")
